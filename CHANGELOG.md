...
* Add `confstr`, `ttyname_r/ptsname_r`, `fgetws`, `mempcpy/wmempcpy`, `*cftime`, `chdir`, `chroot`, `copylist`,
  `dbm_open`, `dbminit`, `execvP`, `p2open`, `wordexp`, `fmemopen/fattach`, `ftw/nftw`, `truncate`, `tmpnam_r`, `umask`,
  `inet_*`, `utmp*`, and `mbs/wcs` functions to the list of insecure functions.
